    ...
    css`
      *, *::before, *::after {
      ...
      :host {
        ...
        --chat-primary: var(--vanna-navy);
        --chat-primary-stronger: #01507f;
        --chat-primary-foreground: rgb(255, 255, 255);
        --chat-accent-soft: var(--vanna-accent-primary-subtle);
        --chat-outline: var(--vanna-outline-dimmest);
      ...
      .chat-input-area {
        ...
        padding: var(--vanna-space-3) var(--vanna-space-5) var(--vanna-space-3);
        background: var(--chat-surface);
